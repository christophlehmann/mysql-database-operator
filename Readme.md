...
export KUBE_NAMESPACE=mysql80-database-operator
# The docker image
export IMAGE=the-operator-image
export IMAGE_TAG=latest
# The service is used for creating database and user
export ADMIN_SERVICE_NAME=mysql80.mysql.svc.cluster.local
# The secret contains credentials used to create database and user 
export ADMIN_SECRET_NAME=mysql80-root-credentials
# This is the externalName, see resulting Service manifest above.
export SERVICE_EXTERNAL_NAME=mysql80.mysql.svc.cluster.local
